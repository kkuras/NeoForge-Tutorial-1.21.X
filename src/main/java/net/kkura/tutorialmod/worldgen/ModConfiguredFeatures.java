package net.kkura.tutorialmod.worldgen;
...
public class ModConfiguredFeatures {
    // CF -> PF -> BM
    // what shape is it going to be placed
    ...
    public static final ResourceKey<ConfiguredFeature<?, ?>> BLOODWOOD_KEY = registerKey("bloodwood_key");
